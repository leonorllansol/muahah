...
import classification, impersonal_answers, plug_and_play, query_agent_label_match,\
    query_answer_label_match
...
class Decisor:
    ...
    def bestAnswerByStrategy(self, query, defaultAgentsAnswers, externalAgentsAnswers, query_labels):
        ...
        all_strategies = {"SimpleMajority": SimpleMajority, "PrioritySystem": PrioritySystem, "AgentMultiAnswers": AgentMultiAnswers, "PrioritySystemMultiAnswers": PrioritySystemMultiAnswers, 
                            "PrioritySystemDevelopmentMulti": PrioritySystemDevelopmentMulti, "WeightedVote": WeightedVote, "query_agent": query_agent, "answer_impersonal": answer_impersonal, "query_answer": query_answer, "YesNoStrategy": YesNoStrategy, "OrStrategy": OrStrategy}
